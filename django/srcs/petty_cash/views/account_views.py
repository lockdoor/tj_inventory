...
from petty_cash.forms.account_form import PettyCashAccountForm
...
class PettyCashAccountListView(LoginRequiredMixin, PermissionRequiredMixin, ListView):
    ...
    template_name = 'petty_cash/account_list.html'
    context_object_name = 'accounts'
    permission_required = 'petty_cash.view_pettycashaccount'
...
class PettyCashAccountDetailView(LoginRequiredMixin, PermissionRequiredMixin, DetailView):
    model = PettyCashAccount
    template_name = 'petty_cash/account_detail.html'
...
class PettyCashAccountCreateView(LoginRequiredMixin, PermissionRequiredMixin, CreateView):
    ...
    template_name = 'petty_cash/account_form.html'
    success_url = reverse_lazy('petty_cash:account-list')
    permission_required = 'petty_cash.add_pettycashaccount'
...
class PettyCashAccountUpdateView(LoginRequiredMixin, PermissionRequiredMixin, UpdateView):
    ...
    template_name = 'petty_cash/account_form.html'
    success_url = reverse_lazy('petty_cash:account-list')
    permission_required = 'petty_cash.change_pettycashaccount'
...
class PettyCashAccountDeleteView(LoginRequiredMixin, PermissionRequiredMixin, DeleteView):
    model = PettyCashAccount
    template_name = 'petty_cash/account_confirm_delete.html'
    success_url = reverse_lazy('petty_cash:account-list')
    permission_required = 'petty_cash.delete_pettycashaccount'
    ...
    def form_valid(self, form):
        try:
            ...
            return redirect('petty_cash:account-detail', pk=self.object.pk)


class PettyCashAccountTrashListView(LoginRequiredMixin, PermissionRequiredMixin, ListView):
    model = PettyCashAccount
    template_name = 'petty_cash/account_trash_list.html'
    context_object_name = 'accounts'
    permission_required = 'petty_cash.delete_pettycashaccount'
...
class PettyCashAccountRestoreView(LoginRequiredMixin, PermissionRequiredMixin, View):
    ...
    def post(self, request, pk, *args, **kwargs):
        ...
        return redirect('petty_cash:account-list')
