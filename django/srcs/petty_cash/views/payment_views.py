...
from petty_cash.models import PettyCashPayment, PettyCashAccount, PettyCashPaymentItem
from petty_cash.forms.payment_form import PettyCashPaymentForm, PettyCashPaymentItemFormSet
...
class PettyCashPaymentListView(LoginRequiredMixin, PermissionRequiredMixin, ListView):
    ...
    template_name = 'petty_cash/payment_list.html'
    context_object_name = 'payments'
    permission_required = 'petty_cash.view_pettycashpayment'
...
class PettyCashPaymentDetailView(LoginRequiredMixin, PermissionRequiredMixin, DetailView):
    model = PettyCashPayment
    template_name = 'petty_cash/payment_detail.html'
...
class PettyCashPaymentCreateView(LoginRequiredMixin, PermissionRequiredMixin, CreateView):
    ...
    template_name = 'petty_cash/payment_form.html'
    permission_required = 'petty_cash.add_pettycashpayment'
    ...
    def form_valid(self, form):
        ...
        if formset.is_valid():
            ...
            try:
                ...
                return redirect('petty_cash:payment-list', account_code=account.code)
...
class PettyCashPaymentUpdateView(LoginRequiredMixin, PermissionRequiredMixin, UpdateView):
    ...
    form_class = PettyCashPaymentForm
    template_name = 'petty_cash/payment_form.html'
    permission_required = 'petty_cash.change_pettycashpayment'
    ...
    def dispatch(self, request, *args, **kwargs):
        ...
        if payment.is_posted:
            ...
            return redirect('petty_cash:payment-detail', pk=payment.pk)
...
class PettyCashPaymentCancelView(LoginRequiredMixin, PermissionRequiredMixin, View):
    permission_required = 'petty_cash.delete_pettycashpayment'
    ...
    def post(self, request, pk, *args, **kwargs):
        ...
        return redirect('petty_cash:payment-list', account_code=account_code)


class PettyCashPaymentTrashListView(LoginRequiredMixin, PermissionRequiredMixin, ListView):
    model = PettyCashPayment
    template_name = 'petty_cash/payment_trash_list.html'
    context_object_name = 'payments'
    permission_required = 'petty_cash.delete_pettycashpayment'
...
class PettyCashPaymentSummaryView(LoginRequiredMixin, PermissionRequiredMixin, TemplateView):
    template_name = 'petty_cash/payment_summary.html'
    permission_required = 'petty_cash.change_pettycashpayment'
